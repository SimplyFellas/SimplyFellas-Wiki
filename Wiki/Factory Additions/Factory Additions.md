...
## Getting Started with Factory Additions

**Essential Mods to Learn:**

**Alloy Forgery:**
- Early-game ore duplication method
- Basic alloy forging setup
- Useful for increasing resource yields

**ComputerCraft (CC: Tweaked):**
- Programmable computers and turtles
- Lua programming language
- Advanced automation through code
- See [Advanced Mechanics Guide](Advanced-Mechanics) for programming basics

**Modular Routers:**
- Powerful item routing system
- Flexible automation tool
- Works great with Create
- See [Transportation & Logistics Guide](Transportation-&-Logistics) for routing guides

**Rechiseled:**
- Decorative block variants
- Chisel tool for customization
- Great for building
- See [Decorative Building Guide](Decorative-Building) for usage

For complete guides on these systems, visit the [Guides Homepage](Guides-Homepage).
...
<img src="Wiki/Factory Additions/Alloy Forging.png" alt="Alloy Forgery" class="inline-image">
...
<img src="Wiki/Factory Additions/ComputerCraft.png" alt="ComputerCraft" class="inline-image">
...
<img src="Wiki/Factory Additions/Rechiseled.png" alt="Rechiseled" class="inline-image">
...
<img src="Wiki/Factory Additions/VillagersWand.png" alt="Villagers Wand" class="inline-image">
...
<img src="Wiki/Factory Additions/Zipline.png" alt="Zipline" class="inline-image">
...
<div class="image-gallery">
    <div class="gallery-item">
        <img src="Wiki/Factory Additions/Alloy Forging.png" alt="Alloy Forgery">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Factory Additions/ComputerCraft.png" alt="ComputerCraft">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Factory Additions/Rechiseled.png" alt="Rechiseled">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Factory Additions/VillagersWand.png" alt="Villagers Wand">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Factory Additions/Zipline.png" alt="Zipline">
    </div>
</div>
