...
**Shaders:**
- Iris Shaders included for shader support
- Compatible with OptiFine shader packs
- Dramatically enhances visuals
- See shader setup section below

**Visual Enhancements:**
- BetterGrassify for improved grass rendering
- Continuity/Fusion for connected textures
- Falling Leaves for atmospheric effects
- Distant Horizons for extended view distance

**Furniture:**
- Macaw's Furniture for decorative items
- Various furniture pieces available
- See [Decorative Building Guide](Decorative-Building) for usage

### Shader Setup Guide

**Installing Shaders:**
1. Download a shader pack (OptiFine-compatible)
2. Place in `.minecraft/shaderpacks/` folder
3. Press `ESC` → `Video Settings` → `Shaders`
4. Select your shader pack
5. Adjust settings as needed

**Recommended Shader Packs:**
- Complementary Shaders (pre-patched with Euphoria)
- Other OptiFine-compatible shaders
- Test performance with your system

**Performance Tips:**
- Shaders significantly impact FPS
- Start with lighter shader packs
- Adjust shader settings for balance
- Disable if experiencing low FPS

For building and decoration guides, see the [Decorative Building Guide](Decorative-Building).
...
<img src="Wiki/Visuals/Shaders.png" alt="Iris Shaders" class="inline-image">
...
<img src="Wiki/Visuals/BetterGrass.png" alt="BetterGrassify" class="inline-image">
...
<img src="Wiki/Visuals/FallingLeaves.gif" alt="Falling Leaves" class="inline-image">
...
<img src="Wiki/Visuals/DistantHorizons.png" alt="Distant Horizons" class="inline-image">
...
<img src="Wiki/Visuals/NotEnoughAnimations.png" alt="Not Enough Animations" class="inline-image">
...
<img src="Wiki/Visuals/CherryForest.png" alt="Cherry Forest" class="inline-image">
<img src="Wiki/Visuals/EndCity.png" alt="End City" class="inline-image">
...
<div class="image-gallery">
    <div class="gallery-item">
        <img src="Wiki/Visuals/BetterGrass.png" alt="BetterGrassify">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Visuals/CherryForest.png" alt="Cherry Forest">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Visuals/DistantHorizons.png" alt="Distant Horizons">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Visuals/EndCity.png" alt="End City">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Visuals/FallingLeaves.gif" alt="Falling Leaves">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Visuals/NotEnoughAnimations.png" alt="Not Enough Animations">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Visuals/Shaders.png" alt="Shaders">
    </div>
</div>
