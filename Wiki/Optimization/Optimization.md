...
**Memory Optimization:**
- Allocate 6-8GB RAM minimum (8-10GB recommended)
- Don't allocate more than 75% of total system RAM
- Close unnecessary background applications
- Use optimization mods (already included)

**Rendering Optimization:**
- Adjust render distance (8-12 chunks recommended)
- Lower entity render distance if needed
- Disable shaders if experiencing low FPS
- Use Sodium settings to optimize further

**Chunk Loading:**
- C2ME optimizes chunk generation automatically
- Smooth Chunk Save reduces lag spikes
- Chunk Sending optimizes multiplayer performance
...
2. Disable shaders temporarily
3. Lower entity render distance
4. Check if optimization mods are active
...
4. Check for memory leaks (Fix GPU Memory Leak should help)

**Lag Spikes:**
1. Smooth Chunk Save should help automatically
2. Reduce render distance
3. Limit active Create contraptions
4. Check server performance (if multiplayer)

For installation and system requirements, see the [Wiki Homepage](Wiki-Homepage).
...
<img src="Wiki/Optimization/Sodium.png" alt="Sodium" class="inline-image">
...
<img src="Wiki/Optimization/EntityCulling.png" alt="Entity Culling" class="inline-image">
...
<img src="Wiki/Optimization/CreateFPS.png" alt="Create Better FPS" class="inline-image">
<img src="Wiki/Optimization/CreateShaders.png" alt="Create Shaders" class="inline-image">
<img src="Wiki/Optimization/CreateShaders2.png" alt="Create Shaders 2" class="inline-image">
...
<img src="Wiki/Optimization/SmartBounds.png" alt="Create Smart Bounds" class="inline-image">
...
<img src="Wiki/Optimization/C2ME.png" alt="C2ME" class="inline-image">
...
<img src="Wiki/Optimization/Krypton.png" alt="Krypton" class="inline-image">
...
<img src="Wiki/Optimization/NoChatReports.png" alt="NoChatReports" class="inline-image">
...
<img src="Wiki/Optimization/FPSExample.png" alt="FPS Performance Example" class="inline-image">
...
<div class="image-gallery">
    <div class="gallery-item">
        <img src="Wiki/Optimization/C2ME.png" alt="C2ME">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/CreateFPS.png" alt="Create Better FPS">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/CreateShaders.png" alt="Create Shaders">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/CreateShaders2.png" alt="Create Shaders 2">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/EntityCulling.png" alt="Entity Culling">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/FPSExample.png" alt="FPS Example">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/Krypton.png" alt="Krypton">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/NoChatReports.png" alt="NoChatReports">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/SmartBounds.png" alt="Smart Bounds">
    </div>
    <div class="gallery-item">
        <img src="Wiki/Optimization/Sodium.png" alt="Sodium">
    </div>
</div>
